...
class Step5 extends React.Component {
    ...
    display_step_18(value) {
        this.setState({
            new_child_care: value
        });

        if (this.state.new_child_care != '') {
            this.setState({
    ...
    onNextButtonClick() {
        ...
        if (this.state.gloceries == '') {
            ...
            if (this.state.display_step_2 && (this.state.glosarry_exchange_change_after_load_yes || this.state.glosarry_exchange_change_after_load_no)) {
                this.state.errors = {}
                if (!this.state.new_gloceries && this.state.glosarry_exchange_change_after_load_yes) {
                    formIsValid = false;
                    ...
                    if (this.state.display_step_3 && (this.state.clothing_personal_load_yes || this.state.clothing_personal_load_no)) {
                        if (!this.state.new_clothing_personal_care && this.state.clothing_personal_load_yes) {
                            formIsValid = false;
                            ...
                            if (this.state.display_step_5 && (this.state.tv_mobile_expance_loan_yes || this.state.tv_mobile_expance_loan_no)) {
                                if (!this.state.tel_tv && this.state.tv_mobile_expance_loan_yes) {
                                    formIsValid = false;
                                    ...
                                    if (this.state.display_step_7 && (this.state.transport_vahicle_loan_yes || this.state.transport_vahicle_loan_no)) {
                                        if (!this.state.transport_vahicle_loan_new && this.state.transport_vahicle_loan_yes) {
                                            formIsValid = false;
                                            ...
                                            if (this.state.display_step_9 && (this.state.recreation_entertainment_yes || this.state.recreation_entertainment_no)) {
                                                if (!this.state.recreation_entertainment_new && this.state.recreation_entertainment_yes) {
                                                    formIsValid = false;
                                                    ...
                                                    if (this.state.display_step_11 && (this.state.medical_health_yes || this.state.medical_health_no)) {
                                                        if (!this.state.new_medical_health && this.state.medical_health_yes) {
                                                            formIsValid = false;
                                                            ...
                                                            if (!this.state.utility_rates) {
                                                                ...
                                                                if (this.state.display_step_12 && (this.state.utility_rates_yes || this.state.utility_rates_no)) {
                                                                    if (!this.state.new_utility_rates && this.state.utility_rates_yes) {
                                                                        formIsValid = false;
                                                                        ...
                                                                        if (this.state.display_step_13 && (this.state.insurance_yes || this.state.insurance_no)) {
                                                                            if (!this.state.new_insurance && this.state.insurance_yes) {
                                                                                formIsValid = false;
                                                                                ...
                                                                                if (this.state.display_step_15 && (this.state.education_yes || this.state.education_no)) {
                                                                                    if (!this.state.new_education && this.state.education_yes) {
                                                                                        formIsValid = false;
                                                                                        ...
                                                                                        if (this.state.display_step_17 && (this.state.child_care_yes || this.state.child_care_no)) {
                                                                                            if (!this.state.new_child_care && this.state.child_care_yes) {
                                                                                                formIsValid = false;
                                                                                                this.state.errors["new_child_care"] = "This field is required";
                                                                                            } else {
                                                                                                if (!this.state.child_maintainance) {
                                                                                                    formIsValid = false;
                                                                                                ...
                                                                                                if (this.state.display_step_19 && (this.state.child_maintainance_care_yes || this.state.child_maintainance_care_no)) {
                                                                                                    if (!this.state.new_child_maintainance && this.state.child_maintainance_care_yes) {
                                                                                                        formIsValid = false;
                                                                                                        ...
                                                                                                        if (this.state.display_step_20 && (this.state.rent_yes || this.state.rent_no)) {
                                                                                                            if (!this.state.new_rent && this.state.rent_yes) {
                                                                                                                formIsValid = false;
        ...
        return (<>
            <form>
                <div className="container">
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" name='gloceries' onKeyUp={e => this.handleKeyUp(e)} onChange={e => { this.display_step_2(e.target.value) }} />
                    ...
                    {this.state.glosarry_exchange_change_after_load_yes ?
                        <Form.Group>
                            ...
                            <Form.Control type="text" placeholder="" name='new_gloceries' onChange={(e) => { this.display_step_3_yes(e.target.value) }} />
                    ...
                    {(this.state.child_care_yes) ? (<>
                        <Form.Group>
                            ...
                            {this.state.errors ? <Form.Label><strong className="text-danger"> {this.state.errors.new_child_care} </strong></Form.Label> : null}
                        </Form.Group>
                    </>) : null}
            ...
            <div className="row">
                <div className="form-group">
                    ...
                    {this.props.details.current_step < 6 ? (<button className="btn  btn-next  btn-primary float-right ml-2" onClick={() => this.onNextButtonClick()} >Next</button>) : null}
                </div>
            </div>
